...
<p><b>Please fill this form to <i class="text-pink-500">reset your password</i></b></p>
    <form action="forgottenPassword_process.php" method="post" id="loginForm" class="flex items-center justify-center flex-col bg-slate-700 opacity-95 MV-boli p-6 border-4 border-double border-purple-800 rounded-bl-[100px] rounded-tr-[100px] min-w-16 max-w-60 sm:min-w-72 sm:p-2 gap-7">
    ...
    <p class="h-7 flex items-center justify-center flex-wrap text-center">Go back on &thinsp;<a href="../register/register.php" class="text-pink-500 no-underline transform duration-500 hover:text-indigo-400">login</a>&nbsp;page</p><br>
