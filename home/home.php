...
<body class="flex items-center justify-center flex-wrap text-center flex-col gap-[1.25rem] backgroundImg text-[whitesmoke] MV-boli">
    ...
    <div class="flex items-center justify-center flex-col gap-5 sm:max-w-">
        <p class="text-lg sm:text-2xl">
            Hello, dear visitor, my name is Friedrich. <br>I am a junior developper.<br>I am currently learning TypeScript and how
            to use it in my projects. <br> ...Nothing more than that to say about me, except the fact that I like 🤩 videos games 🎮
            and really enjoy learn new things in programmation, 👨‍💻 especially Web Developpement and machine learning.
            <br><br>This page is my first try
            on a CRUD (Create-Read-Update-Delete) application. It was made with PHP, JavaScript, MySQL and Tailwind CSS.
