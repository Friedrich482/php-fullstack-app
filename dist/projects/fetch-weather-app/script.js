...
// // ! This part allows me to create all the cards elements.
// // ! Must be refactored !
...
// humidityIcon.classList.add("size-8");
// humidityIcon.classList.add("relative")
// const humidityDisplay = document.createElement("p");
// humidityDisplay.classList.add("flex");
// humidityDisplay.classList.add("items-center");
// humidityDisplay.classList.add("justify-center");
// humidityDisplay.classList.add("flex-row");
// // Feels Like
// const feelsIcon = document.createElement("img");
// feelsIcon.src = "./icons/cardIcons/thermometer.svg";
// feelsIcon.classList.add("h-7");
// feelsIcon.classList.add("w-12");
// const feelsLikeDisplay = document.createElement("p");
// feelsLikeDisplay.classList.add("flex");
// feelsLikeDisplay.classList.add("items-center");
// feelsLikeDisplay.classList.add("justify-center");
// feelsLikeDisplay.classList.add("flex-row");
// //Wind and speed wind
// const windIcon = document.createElement("img");
// windIcon.src = "./icons/cardIcons/wind.svg";
// windIcon.classList.add("size-7");
// windIcon.classList.add("relative");
// const speedIcon = document.createElement("img");
// speedIcon.src = "./icons/cardIcons/windsock.svg";
// speedIcon.classList.add("size-7");
// speedIcon.classList.add("relative");
// const windDisplay = document.createElement("div");
// const windSpan = document.createElement("span");
// const speedSpan = document.createElement("span");
// windSpan.classList.add("relative", "bottom-1");
// speedSpan.classList.add("relative", "bottom-1");
