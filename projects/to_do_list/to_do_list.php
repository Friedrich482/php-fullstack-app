...
<body class="flex text-center justify-center flex-col gap-5 bg-gray-800">
  ...
  <ul id="list" class="consolas flex justify-center items-start flex-col place-self-center gap-2 text-xl border-2 border-violet-600 border-double p-12 rounded-lg transform duration-500"></ul>
  <div class="flex items-start justify-center flex-wrap gap-5 consolas">
    ...
    <form id="deleteForm" class="flex items-center justify-center flex-wrap gap-3">
      ...
      <button aria-label="remove a task" type="button" class="transiton consolas cursor-pointer rounded-lg border-2 border-violet-600 p-2 text-xl text-white duration-700 hover:border-white active:border-yellow-700 active:bg-slate-500">
        Remove task
      </button>
    </form>
  </div>
