...
<html lang="en">
  ...
  <body class="flex items-center justify-center flex-col gap-1 snakeImg">
    <dialog
      ...
      class="flex items-center justify-center flex-col bg-slate-800 opacity-95 MV-boli p-4 border-4 border-double border-green-500 rounded-bl-[100px] rounded-tr-[100px] min-w-16 max-w-60 sm:min-w-72 sm:p-2 gap-2 z-10 text-[whitesmoke] h-80 outline-none backdrop:blur-lg"
      autofocus="false"
    >
      ...
      <form class="flex items-center justify-center flex-col text-2xl gap-2" method="dialog">
        <div class="w-full">
          <input type="radio" name="difficulty" id="level-easy" value="easy" class="size-4 cursor-pointer" checked/>
        ...
        <div class="w-full">
          <input type="radio" name="difficulty" id="level-hard" value="hard" class="size-4 cursor-pointer"/>
